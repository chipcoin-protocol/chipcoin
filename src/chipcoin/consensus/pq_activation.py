...
PQ_SUPPORT_DEVNET_ACTIVATION_HEIGHT = 120_000
PQ_SUPPORT_TESTNET_ACTIVATION_HEIGHT = 120_000
PQ_SUPPORT_SCHEDULED_NETWORKS = {"devnet", "testnet"}


def pq_support_activation_height(network: str) -> int:
...
def pq_support_is_active(*, network: str, height: int) -> bool:
    """Return whether CHCQ/v2 wallet-spend support is active."""

    return height >= pq_support_activation_height(network)
